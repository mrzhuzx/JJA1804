    ...
    <div id="bd">
        <div id="main">
            ...
            <div class="subfild-content base-info">
                ...
                <input type="text" placeholder="id" name="detailId" value=""/><br/>
                <input type="text" placeholder="订单id" name="orderId" value=""/><br/>
                <input type="text" placeholder="商品id" name="productId" value=""/><br/>
                <input type="text" placeholder="商品名称" name="productName" value=""/><br/>

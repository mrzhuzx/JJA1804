...
<div id="container">
    ...
    <div id="bd">
        <div id="main">
            <form action="smuser/save.do" method="post">
                <h2 class="subfild">
                    <span>添加用户</span>
                </h2>
                ...
                <div class="subfild-content base-info">
                    <div class="kv-item ue-clear">
                        ...
                        <div class="kv-item-content">
                            <input type="text" name="userName" value="阿松" />
                        </div>
                    </div>
                </div>
                <div class="subfild-content base-info">
                ...
                <div class="subfild-content base-info">
                    <div class="kv-item ue-clear">
                        ...
                        <div class="kv-item-content">
                            <input type="text" name="userPhone" value="12508125801" />
                        </div>
                    </div>
                </div>
                <div class="subfild-content base-info">
                    <div class="kv-item ue-clear">
                        ...
                        <div class="kv-item-content">
                            <input type="text" name="roleId" value="3" />
                        </div>
                    </div>
                </div>
                <div class="buttons">
